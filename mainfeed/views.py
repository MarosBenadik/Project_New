...
from .models import Post, Comment, Notification, Image, Tag
from directmessages.models import MessageModel
from .forms import PostForm, CommentForm, ShareForm, ExploreForm
from directmessages.forms import ThreadForm, MessageForm
...
class Explore(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect('/mainfeed/explore')